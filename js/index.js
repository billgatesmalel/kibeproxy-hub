      ...
      <tbody>
        ${data.map(p => `
          <tr>
            ...
            <td class="mono">
              <span class="pass-hidden" id="pass-${p.id}">••••••••</span>
              <button class="show-btn" onclick="togglePass('${p.id}','${p.password}')">Show</button>
            </td>
...
function togglePass(id, pass) {
  ...
  if (el.textContent === '••••••••') { el.textContent = pass; btn.textContent = 'Hide'; }
      ...
      <tbody>
        ${data.map(e => `
          <tr>
            ...
            <td class="mono">
              <span class="pass-hidden" id="epass-${e.id}">••••••••</span>
              <button class="show-btn" onclick="togglePass('epass-${e.id}','${e.password}')">Show</button>
            </td>
            <td class="mono" style="font-size:0.78rem;color:var(--text-muted)">
